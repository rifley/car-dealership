...
public class App {
  public static void main(String[] args) {
    ...
    while(programRunning) {
      System.out.println("Welcome to our car dealership. What would you like to do? Enter one of the following options: All Vehicles or Search Price or Add Vehicle");
      ...
      if (navigationChoice.equals("All Vehicles")){
        ...
        System.out.println("Alright, let's add a vehicle! What year was the car made?");
        ...
        System.out.println("Okie Doke! How many miles does it have?");
        int userVehileMiles = Integer.parseInt(myConsole.readLine());
        System.out.println("Yup. And hows about a price?");
        int userVehiclePrice = Integer.parseInt(myConsole.readLine());
        Vehicle userVehicle = new Vehicle(userVehicleYear, userVehicleBrand, userVehicleModel, userVehileMiles, userVehiclePrice);
        allVehicles.add(userVehicle);
        System.out.println("Alrighty, here's your new vehicle: ");
        System.out.println("--------------");
